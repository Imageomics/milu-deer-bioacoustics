...
- [YAMNet (TensorFlow Hub)](https://tfhub.dev/google/yamnet/1) - pretrained audio embedding model

- [XGBoost](https://xgboost.ai/) - gradient-boosted decision trees for classification

- [scikit-learn](https://scikit-learn.org/stable/) - preprocessing, PCA, and calibration utilities

- [PyTorch / torchaudio](https://pytorch.org/audio/stable/) - audio loading and resampling
